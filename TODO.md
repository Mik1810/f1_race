...
- [ ] Fare documentazione
- [ ] Green flag del racedirector parte spesso (togliere o modificare)
- [ ] Velocizzare lo startmas
### Bug
...
- [ ] La UI ci mette eccessivamente ad aprirsi, probabiomente perchè prova a riscaricare le librerie o a ricreare ogni volta il venv
